...
data_path="/data/users/mtanaka/work/tcomp/bs_MDS/my-gpt2_text_document"
...
vocab_path="/data/users/mtanaka/work/tcomp/bs_MDS/gpt2-vocab.json"
# if [ ! -f "$vocab_path" ]; then
#     wget https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-vocab.json
# fi
merge_path="/data/users/mtanaka/work/tcomp/bs_MDS/gpt2-merges.txt"
